...
where $x \in (-\infty, +\infty)$, $f(x) > 0$, and $f(x)$ is derivable. Then the estimated parameters are $x=\{x_1, x_2, \dots, x_K\}$, which can be estimated by the gradient descent algorithm. Candidates of $f(x)$ are:
